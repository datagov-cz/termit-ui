...
class Footer extends React.Component<FooterProps, FooterState> {
  ...
  public render() {
    ...
    return (
      <footer
        className={classNames("footer-row", { transparent: transparent })}
      >
        <div
          ...
          <Row className="align-items-center">
            <Col xs="auto">
              ...
              <a
                ...
                title={i18n("footer.copyright.kbss")}
              >
                {i18n("footer.copyright.kbss")}
              </a>
              ,&nbsp;
              <a
                href="https://mvcr.cz"
                target="_blank"
                rel="noopener noreferrer"
                title={i18n("footer.copyright.mvcr.tooltip")}
              >
                {i18n("footer.copyright.mvcr")}
              </a>
              ,&nbsp;{new Date().getFullYear()}
            </Col>
          </Row>
        </Col>
        <div className="pl-xs-1 px-sm-3 px-2">
          <a
            href="https://esf2014.esfcr.cz/PublicPortal/Views/Projekty/Public/ProjektDetailPublicPage.aspx?action=get&datovySkladId=F5E162B2-15EC-4BBE-9ABD-066388F3D412"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              id="footer-grant-logo"
              src={
                this.props.locale === Constants.LANG.CS.locale
                  ? grantLogoCz
                  : grantLogoEn
              }
              className="grant-logo"
              alt={i18n("footer.grant.text")}
            />
          </a>
